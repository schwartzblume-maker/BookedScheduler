...
$conf['settings']['database']['user'] = 'forbookedscheduler_user';        // database user with permission to the booked database
$conf['settings']['database']['password'] = 'tcvbt9u7UGUKPtwdjxgEogyhGOPhs6Zs';
$conf['settings']['database']['hostspec'] = 'dpg-d81rso5ckfvc73fggmdg-a.singapore-postgres.render.com';        // ip, dns or named pipe
$conf['settings']['database']['name'] = 'forbookedscheduler';
/**
